...
public class WindowingJobNoAggregation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WindowedProduct> aggregatedPerProductName =
                sourceStream
                        ...
                        .process(new ProductProcessWindowFunction())
    ...
    public static class ProductProcessWindowFunction
            extends ProcessWindowFunction<Product, WindowedProduct, String, TimeWindow> {
        ...
        public void process(
                ...
                final Iterable<Product> input,
                final Collector<WindowedProduct> out) {

            WindowedProduct aggregate = new WindowedProduct();
            for (Product record : input) {
                double price = record.getPrice();
                aggregate.addProduct(price);
            }
            final TimeWindow window = context.window();
            aggregate.setWindow(window);
            aggregate.setProduct_name(product_name);
