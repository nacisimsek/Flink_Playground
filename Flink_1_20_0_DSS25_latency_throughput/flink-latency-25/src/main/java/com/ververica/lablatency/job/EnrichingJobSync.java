...
/** EnrichingJob: enrich products with location synchronously. */
public class EnrichingJobSync {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<EnrichedProduct> enrichedStream =
                sourceStream
                        .keyBy(x -> x.f0.getProduct_name())
                        .process(
                                new EnrichProductWithLocationInfo(
    ...
    public static class EnrichProductWithLocationInfo
            extends KeyedProcessFunction<String, Tuple2<Product, Long>, EnrichedProduct> {
        private static final long serialVersionUID = 1L;
         ...
         */
        public EnrichProductWithLocationInfo(
        ...
        public void processElement(
            ...
            if (cachedLocationInfo != null
                ...
                locationInfo = locationInfoServiceClient.getLocationInfo(product_name);
            ...
            out.collect(new EnrichedProduct(product.f0, locationInfo));
        }
    }
